...
public class PistaTrial {
	...
	private CheckPointTrial checkPoint1;
	private CheckPointTrial checkPoint2;
	private CheckPointTrial checkPoint3;
	private CheckPointTrial checkPoint4;
	private String imageURL;
	private String bodyPath;
			

	public PistaTrial(TampinhaTrialWorld world,  String bodyName,String imageName,
			CheckPointTrial checkPoint1, CheckPointTrial checkPoint2,
			CheckPointTrial checkPoint3, CheckPointTrial checkPoint4) {
	...
	public CheckPointTrial getCheckPoint1() {
		return checkPoint1;
	}

	public void setCheckPoint1(CheckPointTrial checkPoint1) {
		this.checkPoint1 = checkPoint1;
	}

	public CheckPointTrial getCheckPoint2() {
		return checkPoint2;
	}

	public void setCheckPoint2(CheckPointTrial checkPoint2) {
		this.checkPoint2 = checkPoint2;
	}

	public CheckPointTrial getCheckPoint3() {
		return checkPoint3;
	}

	public void setCheckPoint3(CheckPointTrial checkPoint3) {
		this.checkPoint3 = checkPoint3;
	}

	public CheckPointTrial getCheckPoint4() {
		return checkPoint4;
	}

	public void setCheckPoint4(CheckPointTrial checkPoint4) {
