...
public class TampaTrial {
	...
	public TampaTrial(TampinhaTrialWorld world, Vector2 tampa1Position,String id,String imageURL) {
		this.id = id;
	...
	private void createCircleBody(TampinhaTrialWorld world, Vector2 position) {
