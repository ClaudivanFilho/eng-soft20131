...
public class MouseDraggedActionTrial {

	TampinhaTrialWorld world;
	Camera camera;
	 ...
	 * @param camera
	 */
	public MouseDraggedActionTrial(TampinhaTrialWorld world, Camera camera) {
	...
	private void atualizaImagemHead() {
		TampaTrial tampa = world.getTampaDaVez();
